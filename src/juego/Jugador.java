...
public class Jugador extends Personaje implements Iesquivar, Iatacar, Icurar {
    ...
    Icon atacar = new ImageIcon("C:/Users/pinha/OneDrive/Documentos/DAM/PROG/Juego/Iconos/Espada_FondoVerde.png");
    Icon esquivar = new ImageIcon("C:/Users/pinha/OneDrive/Documentos/DAM/PROG/Juego/Iconos/Viento_FondoAzul.png");
    ...
    public void chequeo(Jugador jugador, Monstruo monster, JLabel bicho, File fich) {
        ...
        if (jugador.getHp() <= 0) {
            ...
            while (bucle == true) {
                try {
                    int option = Integer.parseInt(JOptionPane.showInputDialog(null, new JLabel("<html>¿Que quieres hacer ahora?<p>1.Ver registro<p>2.Guardar registro de la partida<p>3.Salir</html>", stats, JLabel.LEADING), "FIN DEL JUEGO", JOptionPane.PLAIN_MESSAGE));
                    switch (option) {
                        case 1:
